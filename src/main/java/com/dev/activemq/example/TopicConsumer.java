package com.dev.activemq.example;
...
public class TopicConsumer implements Runnable {
    ...
    public void run() {
        try {
            ...
            // it will return that
            //Destination topicDestination = session.createQueue("REFINITIV-QUEUE");
            Destination topicDestination = session.createTopic("REFINITIV");
